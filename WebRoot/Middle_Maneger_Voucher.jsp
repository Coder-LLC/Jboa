    ...
    <div id="main">
      ...
      <div id="middle">
          ...
          ${employee.name}  
                        登陆
         <p align="right">   
           <a href="middleManegerQueryVoucher.action?status=1&department_id=${employee.department.id}">未审核</a>&nbsp;&nbsp;
           <a href="middleManegerQueryVoucher.action?status=2&department_id=${employee.department.id}">已通过</a>&nbsp;&nbsp;
           <a href="middleManegerQueryVoucher.action?status=3&department_id=${employee.department.id}">未通过</a>
         </p>      
      </div> 
      ...
      <div id="list">
        <center> 
          ...
          <form name="page" method="post" action="middleManegerQueryVoucher.action?department_id=${employee.department.id}">                    
                                     页码: 
